...
const drawerItems = [
  { name: "View Doctors", icon: FaUserMd, link: "/admin/doctors" },
  { name: "Patients", icon: FaUsers, link: "/admin/patients" },
  { name: "Appointments", icon: FaCalendarCheck, link: "/admin/appointments" },
  { name: "Payments", icon: FaMoneyBill, link: "/admin/payments" },
  { name: "Complaints", icon: FaCommentDots, link: "/admin/complaints" },
];
